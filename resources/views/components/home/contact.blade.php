      ...
      <div class="flex flex-wrap lg:justify-between -mx-4">
         ...
         <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
            <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
                ...
                @csrf
                    <div class="mb-6">
                        <x-forms.input type="text" placeholder="Your Name" x-model="formData.name"
                            ::class="errors.name ? 'border-red-500 focus:border-red-500' : '' "/>
                        <template x-if="errors.name">
                            <div x-text="errors.name[0]" class="text-red-500 text-sm italic"></div>
                        </template>
                    </div>
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        <x-forms.textarea rows="6" placeholder="Your Message" x-model="formData.message"
                            ::class="errors.message ? 'border-red-500 focus:border-red-500' : '' "/>
                        <template x-if="errors.message">
                            <div x-text="errors.message[0]" class="text-red-500 text-sm italic"></div>
                        </template>
                    </div>
                    <div>
                        <x-layout.button class="w-full">
                            Send Message
                        </x-layout.button>
                    </div>
               </form>
